...
function updatePaymentsSummaryCard() {
    ...
    paymentsSummaryActionEl.textContent = `You do not need to pay ${formatCurrency(totalOutstanding)} at once. A good start is ${formatCurrency(suggestedStarter)}; pay using the instructions below and the remainder stays on your account.`;
    syncPaymentShortcutButtons();
}
